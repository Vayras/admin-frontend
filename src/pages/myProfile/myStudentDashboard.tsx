...
import { isRegistrationOpen, isCohortActive, formatCohortType } from '../../utils/cohortUtils';
...
const computeStatus = (startISO: string, endISO: string): string => {
    ...
    <div className="min-h-screen bg-zinc-900 text-zinc-100 px-4 md:px-10 lg:px-16 py-6" style={{ fontFamily: 'Sora, sans-serif' }}>
      ...
      <div className="mx-auto">
        <header className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold">My Student Dashboard</h1>
            <p className="text-zinc-400 text-sm mt-1">View and manage your cohorts.</p>
          </div>
          <button
            onClick={() => navigate('/me')}
            className="b-0 inline-flex items-center gap-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-sm font-medium px-5 py-2.5 rounded-lg border border-zinc-700 transition-colors duration-200"
          >
